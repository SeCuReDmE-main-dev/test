# Prompt 11: Build a visual plan

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-11-build-a-visual-plan.ipynb">Open Jupyter Notebook</a>
...
Convert this idea into a visual plan with boxes and arrows.

## Copy This Prompt

```text
Convert this idea into a visual plan with boxes and arrows. Use simple words, show the expected result, and finish with one next action.
```
