# Prompt 20: Make a glossary

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-20-make-a-glossary.ipynb">Open Jupyter Notebook</a>
...
Create a small glossary for the difficult terms in this topic.

## Copy This Prompt

```text
Create a small glossary for the difficult terms in this topic. Use simple words, show the expected result, and finish with one next action.
```
