# Prompt 24: Plan a worksheet

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-24-plan-a-worksheet.ipynb">Open Jupyter Notebook</a>
...
Create a one-page worksheet for this topic.

## Copy This Prompt

```text
Create a one-page worksheet for this topic. Use simple words, show the expected result, and finish with one next action.
```
