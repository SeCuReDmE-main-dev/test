# Prompt 13: Compare two options

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-13-compare-two-options.ipynb">Open Jupyter Notebook</a>
...
Compare two ways to complete this activity and recommend one.

## Copy This Prompt

```text
Compare two ways to complete this activity and recommend one. Use simple words, show the expected result, and finish with one next action.
```
