# Prompt 12: Find the first risk

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-12-find-the-first-risk.ipynb">Open Jupyter Notebook</a>
...
Name the first learning risk and how to reduce it.

## Copy This Prompt

```text
Name the first learning risk and how to reduce it. Use simple words, show the expected result, and finish with one next action.
```
