# Prompt 22: Plan a group activity

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-22-plan-a-group-activity.ipynb">Open Jupyter Notebook</a>
...
Turn this idea into a small group activity.

## Copy This Prompt

```text
Turn this idea into a small group activity. Use simple words, show the expected result, and finish with one next action.
```
