# Prompt 28: Make it accessible

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-28-make-it-accessible.ipynb">Open Jupyter Notebook</a>
...
Suggest comfort settings for a learner who needs less visual stress.

## Copy This Prompt

```text
Suggest comfort settings for a learner who needs less visual stress. Use simple words, show the expected result, and finish with one next action.
```
