# Prompt 07: Prepare a classroom version

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-07-prepare-a-classroom-version.ipynb">Open Jupyter Notebook</a>
...
Adapt this activity for a classroom with mixed skill levels.

## Copy This Prompt

```text
Adapt this activity for a classroom with mixed skill levels. Use simple words, show the expected result, and finish with one next action.
```
