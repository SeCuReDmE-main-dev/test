# Prompt 15: Make it more challenging

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-15-make-it-more-challenging.ipynb">Open Jupyter Notebook</a>
...
Add an optional challenge for advanced learners.

## Copy This Prompt

```text
Add an optional challenge for advanced learners. Use simple words, show the expected result, and finish with one next action.
```
