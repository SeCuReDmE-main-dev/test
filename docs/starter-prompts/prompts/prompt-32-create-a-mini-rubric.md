# Prompt 32: Create a mini rubric

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-32-create-a-mini-rubric.ipynb">Open Jupyter Notebook</a>
...
Create a simple rubric with beginner, growing, and strong levels.

## Copy This Prompt

```text
Create a simple rubric with beginner, growing, and strong levels. Use simple words, show the expected result, and finish with one next action.
```
