# Prompt 23: Plan a demo

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-23-plan-a-demo.ipynb">Open Jupyter Notebook</a>
...
Create a short demo script for this tool.

## Copy This Prompt

```text
Create a short demo script for this tool. Use simple words, show the expected result, and finish with one next action.
```
