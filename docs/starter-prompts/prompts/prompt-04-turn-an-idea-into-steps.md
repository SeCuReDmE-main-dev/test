# Prompt 04: Turn an idea into steps

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-04-turn-an-idea-into-steps.ipynb">Open Jupyter Notebook</a>
...
Turn my idea into clear steps that a beginner can follow.

## Copy This Prompt

```text
Turn my idea into clear steps that a beginner can follow. Use simple words, show the expected result, and finish with one next action.
```
