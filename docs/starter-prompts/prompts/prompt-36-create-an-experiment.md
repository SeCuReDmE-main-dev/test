# Prompt 36: Create an experiment

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-36-create-an-experiment.ipynb">Open Jupyter Notebook</a>
...
Design a safe learning experiment for this idea.

## Copy This Prompt

```text
Design a safe learning experiment for this idea. Use simple words, show the expected result, and finish with one next action.
```
