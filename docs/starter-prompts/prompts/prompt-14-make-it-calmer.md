# Prompt 14: Make it calmer

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-14-make-it-calmer.ipynb">Open Jupyter Notebook</a>
...
Rewrite this activity so it feels calmer and easier to begin.

## Copy This Prompt

```text
Rewrite this activity so it feels calmer and easier to begin. Use simple words, show the expected result, and finish with one next action.
```
