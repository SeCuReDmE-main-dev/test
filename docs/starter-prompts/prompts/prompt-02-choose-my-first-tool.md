# Prompt 02: Choose my first tool

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-02-choose-my-first-tool.ipynb">Open Jupyter Notebook</a>
...
Help me choose the best SecuredMe Education tool for my current learning goal.

## Copy This Prompt

```text
Help me choose the best SecuredMe Education tool for my current learning goal. Use simple words, show the expected result, and finish with one next action.
```
...
Result wanted: replace with the result you want
```

## Expected Result

A clear beginner-friendly output that can be used right away.

## Next Action

Save the best part and try one small improvement.
