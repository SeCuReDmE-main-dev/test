# Prompt 09: Create a teacher check

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-09-create-a-teacher-check.ipynb">Open Jupyter Notebook</a>
...
Create a simple teacher check for the activity.

## Copy This Prompt

```text
Create a simple teacher check for the activity. Use simple words, show the expected result, and finish with one next action.
```
