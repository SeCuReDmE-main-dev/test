# Prompt 17: Create a beginner prompt

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-17-create-a-beginner-prompt.ipynb">Open Jupyter Notebook</a>
...
Write a beginner prompt for this learning task.

## Copy This Prompt

```text
Write a beginner prompt for this learning task. Use simple words, show the expected result, and finish with one next action.
```
