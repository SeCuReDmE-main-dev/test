# Prompt 29: Make it bilingual

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-29-make-it-bilingual.ipynb">Open Jupyter Notebook</a>
...
Create an English and French version of the activity text.

## Copy This Prompt

```text
Create an English and French version of the activity text. Use simple words, show the expected result, and finish with one next action.
```
