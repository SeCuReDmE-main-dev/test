# Prompt 06: Explain the outcome

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-06-explain-the-outcome.ipynb">Open Jupyter Notebook</a>
...
Tell me what a good result should look like for this activity.

## Copy This Prompt

```text
Tell me what a good result should look like for this activity. Use simple words, show the expected result, and finish with one next action.
```
