# Prompt 08: Prepare a solo version

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-08-prepare-a-solo-version.ipynb">Open Jupyter Notebook</a>
...
Adapt this activity for a student working alone.

## Copy This Prompt

```text
Adapt this activity for a student working alone. Use simple words, show the expected result, and finish with one next action.
```
