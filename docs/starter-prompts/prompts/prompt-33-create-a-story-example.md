# Prompt 33: Create a story example

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-33-create-a-story-example.ipynb">Open Jupyter Notebook</a>
...
Explain this concept through a short student-friendly story.

## Copy This Prompt

```text
Explain this concept through a short student-friendly story. Use simple words, show the expected result, and finish with one next action.
```
