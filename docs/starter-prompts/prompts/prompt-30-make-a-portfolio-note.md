# Prompt 30: Make a portfolio note

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-30-make-a-portfolio-note.ipynb">Open Jupyter Notebook</a>
...
Write a short portfolio note showing what the learner built.

## Copy This Prompt

```text
Write a short portfolio note showing what the learner built. Use simple words, show the expected result, and finish with one next action.
```
