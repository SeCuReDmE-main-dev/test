# Prompt 35: Create a comparison table

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-35-create-a-comparison-table.ipynb">Open Jupyter Notebook</a>
...
Make a table comparing input, action, result, and learning value.

## Copy This Prompt

```text
Make a table comparing input, action, result, and learning value. Use simple words, show the expected result, and finish with one next action.
```
