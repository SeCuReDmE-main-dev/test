# Prompt 39: Make it builder-ready

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-39-make-it-builder-ready.ipynb">Open Jupyter Notebook</a>
...
Turn this learning idea into a builder task list.

## Copy This Prompt

```text
Turn this learning idea into a builder task list. Use simple words, show the expected result, and finish with one next action.
```
