# Prompt 25: Plan feedback

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-25-plan-feedback.ipynb">Open Jupyter Notebook</a>
...
Create kind, useful feedback for a beginner answer.

## Copy This Prompt

```text
Create kind, useful feedback for a beginner answer. Use simple words, show the expected result, and finish with one next action.
```
