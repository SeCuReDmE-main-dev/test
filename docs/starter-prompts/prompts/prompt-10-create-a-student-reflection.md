...
Create three reflection questions for the student.

## Copy This Prompt

```text
Create three reflection questions for the student. Use simple words, show the expected result, and finish with one next action.
```
