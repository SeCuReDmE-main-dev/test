# Prompt 27: Connect to real life

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-27-connect-to-real-life.ipynb">Open Jupyter Notebook</a>
...
Connect this activity to a real-life example.

## Copy This Prompt

```text
Connect this activity to a real-life example. Use simple words, show the expected result, and finish with one next action.
```
