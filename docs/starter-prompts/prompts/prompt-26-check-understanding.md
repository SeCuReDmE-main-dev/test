# Prompt 26: Check understanding

<div class="se-action-row">
  <a class="se-action-link" href="../../notebooks/prompt-26-check-understanding.ipynb">Open Jupyter Notebook</a>
...
Create five questions that check understanding without pressure.

## Copy This Prompt

```text
Create five questions that check understanding without pressure. Use simple words, show the expected result, and finish with one next action.
```
